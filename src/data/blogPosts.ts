...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    titleKey: "blog.posts.propertyMarketTrendsItaly.title",
    excerptKey: "blog.posts.propertyMarketTrendsItaly.excerpt",
    author: "Elena Ferrari",
    authorBio:
      "Elena is a market analyst who tracks real estate trends across Italy. She provides timing advice for buyers and renters.",
    date: "2025-02-01",
  ...
  },
  {
    ...
    titleKey: "blog.posts.whereToBuyPropertyItaly.title",
    excerptKey: "blog.posts.whereToBuyPropertyItaly.excerpt",
    author: "Giuseppe Bianchi",
    authorBio:
      "Giuseppe has over 15 years of experience in the Italian real estate market. He provides insights on market trends and investment opportunities.",
    date: "2025-01-28",
  ...
  },
  {
    ...
    titleKey: "blog.posts.annualCostsOwningPropertyItaly.title",
    excerptKey: "blog.posts.annualCostsOwningPropertyItaly.excerpt",
    author: "Marco De Luca",
    authorBio:
      "Marco is a real estate attorney with expertise in Italian property law. He helps international clients understand the legal aspects of buying and renting in Italy.",
    date: "2025-01-20",
