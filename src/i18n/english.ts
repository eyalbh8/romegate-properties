export default {
  ...
  properties: {
    ...
    propertyTitles: {
      modernApartmentTrastevere: "Modern Apartment in Trastevere",
      luxuryVillaNearColosseum: "Luxury Villa near Colosseum",
      studentStudioNearSapienza: "Student Studio near Sapienza",
      cozyApartmentCentroStorico: "Cozy Apartment in Centro Storico",
      elegantPenthouseWithTerrace: "Elegant Penthouse with Terrace",
      sharedStudentRoom: "Shared Student Room",
    },
  },
  blog: {
    title: "News & Insights",
  ...
  contact: {
    ...
    form: {
      ...
      phoneDescription: "Optional: Enter your phone number for faster contact",
      subjectDescription: "Please enter the subject of your message",
      messageDescription: "Please enter your message or inquiry",
    },
