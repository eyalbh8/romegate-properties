export default {
  ...
  services: {
    ...
    buyingProperties: {
      ...
      process: {
        ...
        step6: {
          title: "Verifica della proprietà e Catasto",
          description:
            "Verifichiamo che l'immobile sia regolarmente registrato a nome del venditore e libero da ipoteche, tramite il Catasto.",
        },
        step7: {
          title: "Verifiche tecniche e conformità",
          description:
            "Consigliamo un ingegnere qualificato per controllare la conformità edilizia e urbanistica dell'immobile, così da evitare vizi nascosti o opere abusive.",
        },
      },
      pricing:
  ...
  uniqueSection: {
    ...
    erasmusStudentSpecialists: {
      ...
      description:
        "Siamo la scelta #1 per gli studenti Erasmus. Dal trovare alloggi convenienti all'aiuto con la burocrazia e l'insediamento, rendiamo la tua transizione fluida.",
    },
    multilingualSupport: {
      title: "Supporto Multilingue",
      description:
        "Il nostro team parla inglese, italiano, spagnolo, francese e altro ancora. Garantiamo una comunicazione chiara per tutti i nostri clienti internazionali.",
    },
    primeLocations: {
    ...
    personalizedService: {
      ...
      description:
        "Ogni cliente è unico. Forniamo soluzioni su misura, che tu stia acquistando un appartamento di lusso o cercando una camera per studenti.",
    },
    fastAndEfficient: {
      title: "Veloce ed Efficiente",
      description:
        "Capiamo che gli studenti hanno bisogno di alloggi rapidamente. Il nostro processo snello ti permette di sistemarti velocemente, spesso entro pochi giorni.",
    },
  },
  erasmusSection: {
    ...
    primeLocations: {
      title: "Posizioni Prime",
      description:
        "Quartieri sicuri con eccellenti collegamenti di trasporto pubblico",
    },
    flexibleLeases: {
      title: "Affitti Flessibili",
      description:
        "Contratti semestrali che corrispondono al tuo periodo di studio",
    },
    fullSupport: {
  ...
  properties: {
    ...
    noPropertiesFound:
      "Nessuna proprietà trovata corrispondente ai tuoi criteri.",
    viewAllProperties: "Visualizza Tutte le Proprietà",
    propertyDetails: "Dettagli Proprietà",
    description: "Descrizione",
    amenities: "Servizi",
    transport: "Collegamenti",
    bedrooms: "Camere da letto",
    bathrooms: "Bagni",
    area: "Superficie",
    builtUpArea: "Superficie coperta",
    land: "Terreno",
    floor: "Piano",
    contactUs: "Contattaci",
    amenityTypes: {
      ...
      elevator: "Ascensore",
      desk: "Scrivania",
      shared_kitchen: "Cucina in comune",
    ...
    propertyTitles: {
      modernApartmentTrastevere: "Appartamento Moderno a Trastevere",
      luxuryVillaNearColosseum: "Villa di Lusso vicino al Colosseo",
      studentStudioNearSapienza: "Monolocale per Studenti vicino alla Sapienza",
      cozyApartmentCentroStorico: "Accogliente Appartamento nel Centro Storico",
      elegantPenthouseWithTerrace: "Elegante Attico con Terrazza",
      sharedStudentRoom: "Camera Condivisa per Studenti",
    },
  },
  blog: {
    title: "Notizie e Approfondimenti",
    subtitle:
      "Resta aggiornato sulle ultime tendenze immobiliari, guide per studenti e approfondimenti di mercato",
    categories: {
      all: "Tutti",
      studentLife: "Vita da Studente",
      realEstate: "Immobiliare",
      investment: "Investimenti",
      legal: "Legale",
    },
    readMore: "Leggi di Più",
    viewAllPosts: "Visualizza Tutti gli Articoli",
    noPostsFound: "Nessun articolo trovato in questa categoria.",
    posts: {
      top5Neighborhoods: {
...
<p>Accantonate fondi per manutenzione ordinaria, riparazioni e, se prevista, assicurazione dello stabile. Negli edifici storici o antichi la manutenzione può essere più onerosa. È consigliabile un fondo per emergenze di qualche migliaio di euro.</p>`,
  ...
  faq: {
    ...
    questions: {
      ...
      howLongToFindProperty: {
        question: "Quanto tempo ci vuole per trovare una proprietà?",
        answer:
          "Per gli studenti, spesso troviamo alloggi adatti entro 3-7 giorni. Per acquirenti o affittuari a lungo termine, il processo richiede tipicamente 2-4 settimane a seconda dei tuoi requisiti specifici e della disponibilità di mercato.",
      },
      propertyManagementServices: {
        question: "Offrite servizi di gestione proprietà?",
        answer:
      ...
      languagesSpoken: {
        ...
        answer:
          "Il nostro team è multilingue e può assisterti in inglese, italiano, spagnolo, francese e tedesco. Garantiamo una comunicazione chiara per tutti i nostri clienti internazionali.",
      },
      virtualTours: {
        question: "Offrite visite virtuali alle proprietà?",
        answer:
          "Sì, offriamo visite virtuali per molte delle nostre proprietà. Questo è particolarmente utile per clienti internazionali e studenti che non possono visitare di persona prima di prendere una decisione.",
      },
    },
  },
  contact: {
    title: "Contattaci",
    subtitle: "Mettiti in contatto con il nostro team - siamo qui per aiutarti",
    ...
    form: {
      ...
      nameDescription: "Inserisci il tuo nome completo",
      emailDescription: "Inserisci un indirizzo email valido",
      phoneDescription:
        "Opzionale: Inserisci il tuo numero di telefono per un contatto più rapido",
      subjectDescription: "Inserisci l'oggetto del tuo messaggio",
      messageDescription: "Inserisci il tuo messaggio o richiesta",
    },
  ...
  footer: {
    ...
    services: "Servizi",
    contact: "Contatti",
    buyingProperties: "Acquisto Proprietà",
    sellingProperties: "Vendita Proprietà",
  ...
  guides: {
    title: "Guide all'acquisto di immobili in Italia",
    subtitle:
      "Guide esperte su processo d'acquisto, burocrazia, tasse, finanziamenti e tutto ciò che serve sapere.",
    categories: {
      all: "Tutte",
      buying: "Acquisto",
      bureaucracy: "Burocrazia e documenti",
      taxCosts: "Tasse e costi",
      financing: "Finanziamenti",
      legal: "Aspetti legali",
      market: "Mercato",
    },
    metaDescription:
      "Guide esperte su come comprare casa in Italia: processo, burocrazia, tasse, finanziamenti e verifiche legali. Tutto ciò che serve per un acquisto sicuro.",
...
<p>Contattate Vero Properties per la ricerca immobiliare e il coordinamento con consulenti legali su residenza e visti.</p>`,
  ...
  buying: {
    faq1: {
      question: "Quanto tempo richiede il processo di acquisto?",
      answer:
        "Dall'offerta alla consegna delle chiavi in genere 2–4 mesi, a seconda del finanziamento e di eventuali condizioni. Il contratto preliminare si firma di solito entro poche settimane dall'offerta accettata.",
    },
    faq2: {
      question: "Devo essere in Italia per comprare?",
      answer:
        "Potete iniziare da remoto. Dovrete essere in Italia per il contratto preliminare (compromesso) e per il rogito davanti al notaio, oppure conferire procura a un rappresentante.",
    },
    faq3: {
      question: "Posso ottenere un mutuo come non residente?",
      answer:
        "Sì. Molte banche italiane concedono mutui ai non residenti. LTV tipico 50–70%. Serviranno prova di reddito, documento e spesso il Codice Fiscale.",
    },
    faq4: {
      question: "Mi serve il Codice Fiscale italiano?",
      answer:
        "Sì. Il Codice Fiscale è necessario per firmare l'atto e registrare l'acquisto. Si ottiene in ambasciata o consolato italiano nel proprio paese o presso un ufficio dell'Agenzia delle Entrate con documento valido.",
    },
    faq5: {
      question: "Quali tasse pago in fase di acquisto?",
      answer:
        "Le imposte dipendono dal fatto che sia la prima casa (prima casa) e dal valore. Per la prima casa circa 2% di imposta di registro più tasse fisse; per seconda casa o immobile di lusso circa 9% nella maggior parte delle regioni. Il notaio fornirà un preventivo preciso.",
    },
  },
  seo: {
    title:
